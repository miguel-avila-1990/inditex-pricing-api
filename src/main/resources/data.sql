INSERT INTO brands (id, name, country, description, active) VALUES
(1, 'ZARA', 'España', 'Marca líder en moda rápida del grupo Inditex.', true);

INSERT INTO products (id, name, category, size, gender, color, collection) VALUES
(35455, 'Camiseta básica blanca', 'camiseta', 'M', 'unisex', 'blanco', 'primavera-verano 2020');
